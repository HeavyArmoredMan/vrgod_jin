...
public class ScreenCaptureFragment extends Fragment implements
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        LinearLayout.LayoutParams lp = (android.widget.LinearLayout.LayoutParams) mSurfaceView.getLayoutParams();
        ...
        case R.id.toggle:
            if (mVirtualDisplay == null) {
                ...
                LinearLayout.LayoutParams mParams = new LinearLayout.LayoutParams(
                		getResources().getDisplayMetrics().widthPixels + (checkDeviceHasNavigationBar(getActivity())?getNavigationBarHeight():0), getResources().getDisplayMetrics().heightPixels + getStatusBarHeight());
                Log.i("VR","checkDeviceHasNavigationBar"+ checkDeviceHasNavigationBar(getActivity()));
                mParams.setMargins(getResources().getDisplayMetrics().widthPixels/2, 0-getStatusBarHeight()-getStatusBarHeight()/2, 0, 0);
